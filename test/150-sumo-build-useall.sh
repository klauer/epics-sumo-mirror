...
$PYTHON ../../bin/sumo-build --builddb BUILDS --db DEPS.DB useall MYAPP-001 -o - | sed -e "s#`pwd -P`##"

echo -e "\nsumo-build useall AUTO-001:"
$PYTHON ../../bin/sumo-build --builddb BUILDS --db DEPS.DB useall AUTO-001 -o - | sed -e "s#`pwd -P`##"
